url --url http://147.11.105.120/mirror/centos/8-stream/BaseOS/$basearch/os/
repo --name="AppStream" --baseurl=http://147.11.105.120/mirror/centos/8-stream/AppStream/$basearch/os/
